...
HD_PWD='C:/Users/chawlani/Lock_In_Red_pitaya/Lock_In_Red_pitaya.runs/FirstDraftBD_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirstDraftBD_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirstDraftBD_clk_wiz_0_1.tcl
