...
HD_PWD='D:/repos/red_pitaya_opo_locking/updated_RePLIA_vivado_project/VivadoProject/Lock_In_Red_pitaya/Lock_In_Red_pitaya.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirstDraftBD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirstDraftBD_wrapper.tcl
