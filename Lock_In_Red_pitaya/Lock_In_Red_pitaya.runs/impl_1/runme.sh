...
HD_PWD='D:/repos/red_pitaya_opo_locking/updated_RePLIA_vivado_project/VivadoProject/Lock_In_Red_pitaya/Lock_In_Red_pitaya.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FirstDraftBD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FirstDraftBD_wrapper.tcl -notrace
